...
const API_URL = 'http://172.16.7.14:3000/cadastro';
    ...
    <View style={styles.CadastroForm}>
     ...
     {/* Botão criado para testar se o Cep posto está correto e preenchendo a constante 'endereco'*/}
      ...
      <View style={styles.formActions}>
        <Button title="Salvar"  id="save" onPress={handleSubmit} disabled={cpf.length == 0 || nome.length == 0 || idade.length == 0 || cep.length !== 8 || endereco.length == 0} />
